...
export class EnhancedMCPIntegration {
    ...
    if (this.cliAvailable) {
      try {
        ...
        if (setupResult.success) {
          // Add CLI-generated files to the guide
          baseGuide.cliGenerated = {
            setupFilesCreated: true,
            location: '.nodash/setup/',
            note: 'Setup files have been generated by CLI and are ready to use'
          };
  ...
  private combineAnalysisResults(mcpAnalysis: any, cliAnalysis: any, configStatus: any): any {
    ...
    if (mcpAnalysis.recommendations) {
      combined.recommendations.push(...mcpAnalysis.recommendations);
    }
    if (cliAnalysis?.recommendations) {
